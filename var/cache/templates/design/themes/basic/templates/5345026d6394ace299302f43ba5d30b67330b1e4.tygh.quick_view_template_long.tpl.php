<?php /* Smarty version Smarty-3.1.15, created on 2014-04-08 20:47:39
         compiled from "/var/www/medinweb.ru/public/design/themes/basic/templates/views/products/components/quick_view_template_long.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8021101735344282befc629-62727154%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5345026d6394ace299302f43ba5d30b67330b1e4' => 
    array (
      0 => '/var/www/medinweb.ru/public/design/themes/basic/templates/views/products/components/quick_view_template_long.tpl',
      1 => 1396611751,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '8021101735344282befc629-62727154',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5344282c41c420_22415495',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5344282c41c420_22415495')) {function content_5344282c41c420_22415495($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/medinweb.ru/public/app/functions/smarty_plugins/function.script.php';
...
<?php $_smarty_tpl->tpl_vars["obj_id"] = new Smarty_variable((($tmp = @$_smarty_tpl->tpl_vars['product']->value['view_id'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['product']->value['product_id'] : $tmp), null, 0);?>
<?php $_smarty_tpl->tpl_vars["obj_prefix"] = new Smarty_variable("ajax", null, 0);?>
<div class="product-main-info product-quick-view long" id="product_main_info_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');?>
">
...
<?php echo $_smarty_tpl->getSubTemplate ("common/product_data.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('obj_prefix'=>$_smarty_tpl->tpl_vars['obj_prefix']->value,'obj_id'=>$_smarty_tpl->tpl_vars['obj_id']->value,'product'=>$_smarty_tpl->tpl_vars['product']->value,'but_role'=>"big",'but_text'=>__("add_to_cart"),'form_meta'=>"cm-form-dialog-closer"), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])) {?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A") {?><span class="cm-template-box template-box" data-ca-te-template="views/products/components/quick_view_template_long.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/products/components/quick_view_template_long.tpl"),$_smarty_tpl);?>
