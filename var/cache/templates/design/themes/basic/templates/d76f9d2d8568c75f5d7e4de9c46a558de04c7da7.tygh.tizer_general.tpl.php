<?php /* Smarty version Smarty-3.1.15, created on 2014-04-08 18:43:00
         compiled from "/var/www/medinweb.ru/public/design/themes/basic/templates/blocks/wrappers/tizer_general.tpl" */ ?>
<?php /*%%SmartyHeaderCode:212651659853440712eed4b6-24340155%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd76f9d2d8568c75f5d7e4de9c46a558de04c7da7' => 
    array (
      0 => '/var/www/medinweb.ru/public/design/themes/basic/templates/blocks/wrappers/tizer_general.tpl',
      1 => 1396968177,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '212651659853440712eed4b6-24340155',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_53440713143f86_11717604',
  'variables' => 
  array (
    'runtime' => 0,
    'content' => 0,
...
<?php if ($_valid && !is_callable('content_53440713143f86_11717604')) {function content_53440713143f86_11717604($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/medinweb.ru/public/app/functions/smarty_plugins/block.hook.php';
...
"></a>
    <?php }?>
    <div class="tizer clearfix<?php if (isset($_smarty_tpl->tpl_vars['hide_wrapper']->value)) {?> cm-hidden-wrapper<?php }?><?php if ($_smarty_tpl->tpl_vars['hide_wrapper']->value) {?> hidden<?php }?><?php if ($_smarty_tpl->tpl_vars['details_page']->value) {?> details-page<?php }?><?php if ($_smarty_tpl->tpl_vars['block']->value['user_class']) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['user_class'], ENT_QUOTES, 'UTF-8');?>
...
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])) {?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A") {?><span class="cm-template-box template-box" data-ca-te-template="blocks/wrappers/tizer_general.tpl" id="<?php echo smarty_function_set_id(array('name'=>"blocks/wrappers/tizer_general.tpl"),$_smarty_tpl);?>
