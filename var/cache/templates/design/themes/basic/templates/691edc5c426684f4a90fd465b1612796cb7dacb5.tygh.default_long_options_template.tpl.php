<?php /* Smarty version Smarty-3.1.15, created on 2014-04-07 17:04:46
         compiled from "/var/www/medinweb.ru/public/design/themes/basic/templates/blocks/product_templates/default_long_options_template.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13440145795342a26ecb0fc2-44244736%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '691edc5c426684f4a90fd465b1612796cb7dacb5' => 
    array (
      0 => '/var/www/medinweb.ru/public/design/themes/basic/templates/blocks/product_templates/default_long_options_template.tpl',
      1 => 1396611751,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '13440145795342a26ecb0fc2-44244736',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5342a26f40d9f0_62573502',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5342a26f40d9f0_62573502')) {function content_5342a26f40d9f0_62573502($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/medinweb.ru/public/app/functions/smarty_plugins/function.script.php';
...
_update--></div>
        ...
        <div class="product-info">
            ...
            <div class="<?php if (trim(Smarty::$_smarty_vars['capture'][$_smarty_tpl->tpl_vars['old_price']->value])||trim(Smarty::$_smarty_vars['capture'][$_smarty_tpl->tpl_vars['clean_price']->value])||trim(Smarty::$_smarty_vars['capture'][$_smarty_tpl->tpl_vars['list_discount']->value])) {?>prices-container <?php }?>price-wrap clearfix product-detail-price">
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])) {?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A") {?><span class="cm-template-box template-box" data-ca-te-template="blocks/product_templates/default_long_options_template.tpl" id="<?php echo smarty_function_set_id(array('name'=>"blocks/product_templates/default_long_options_template.tpl"),$_smarty_tpl);?>
