<?php /* Smarty version Smarty-3.1.15, created on 2014-04-05 17:31:53
         compiled from "/var/www/medinweb.ru/public/design/backend/templates/addons/twigmo/settings/settings.tpl" */ ?>
<?php /*%%SmartyHeaderCode:660892337534005c9625672-18413158%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ec42bf3de8b495455b607163afd5d4451051df3c' => 
    array (
      0 => '/var/www/medinweb.ru/public/design/backend/templates/addons/twigmo/settings/settings.tpl',
      1 => 1396609142,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '660892337534005c9625672-18413158',
  'function' => 
  array (
  ),
  'variables' => 
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>__("tt_addons_twigmo_settings_settings_twgadmin_home_page_content")), 0);?>
:</label>
        <div class="controls">
...
:</label>
        <div class="controls">
            <div class="float-left">
                <?php echo $_smarty_tpl->getSubTemplate ("common/fileuploader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('var_name'=>"tw_settings[logo]",'image'=>true), 0);?>
...
:</label>
        <div class="controls">
            <div class="float-left">
                <?php echo $_smarty_tpl->getSubTemplate ("common/fileuploader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('var_name'=>"tw_settings[favicon]",'image'=>true), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>__("tt_addons_twigmo_settings_settings_twgadmin_enable_geolocation")), 0);?>
:</label>
        <div  class="controls">
