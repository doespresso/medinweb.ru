<?php /* Smarty version Smarty-3.1.15, created on 2014-04-05 17:14:15
         compiled from "/var/www/medinweb.ru/public/design/backend/templates/views/companies/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:819425580534001a7f24e34-07296860%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fdd2c8fb501e058d49febb5d3a5cdd8545ebb02a' => 
    array (
      0 => '/var/www/medinweb.ru/public/design/backend/templates/views/companies/update.tpl',
      1 => 1396609142,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '819425580534001a7f24e34-07296860',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_534001a86fae95_90278578',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_534001a86fae95_90278578')) {function content_534001a86fae95_90278578($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/medinweb.ru/public/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_unpuny')) include '/var/www/medinweb.ru/public/app/functions/smarty_plugins/modifier.unpuny.php';
...
<form class="form-horizontal form-edit <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_class']->value, ENT_QUOTES, 'UTF-8');?>
 <?php if (!fn_check_view_permissions("companies.update","POST")) {?>cm-hide-inputs<?php }?>" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'UTF-8');?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>   
    ...
    <?php } else { ?>
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_name'=>"dispatch[companies.add]",'but_target_form'=>"company_update_form"), 0);?>
