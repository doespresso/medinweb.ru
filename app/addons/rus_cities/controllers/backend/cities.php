...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    return array(CONTROLLER_STATUS_OK, "cities.manage?state_id={$params['state_code']}&country_code={$params['country_code']}");
}
...
if ($mode == 'manage') {
    ...
    return array(CONTROLLER_STATUS_REDIRECT, "cities.manage?state_id={$params['state_id']}&country_code={$params['country_code']}");
}
