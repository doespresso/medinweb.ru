...
if ($mode == 'market_category') {

    $categories_tree = fn_get_market_category();

    Registry::get('view')->assign('categories_tree', $categories_tree);
    Registry::get('view')->display('addons/rus_yandex_market/market_category.tpl');
    exit;
}

if ($mode == 'market_category_autocomplete') {
